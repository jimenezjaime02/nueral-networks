...
def main():
    ...
    parser.add_argument('--input_dim', type=int, default=784, help='Input dimension (e.g., 784 for MNIST)')
    parser.add_argument('--hidden_dims', type=int, nargs='+', default=[400, 200], 
                        help='Hidden layer dimensions (e.g., 400 200)')
    parser.add_argument('--latent_dim', type=int, default=20, help='Latent space dimension')
    parser.add_argument('--output_dist', type=str, default='bernoulli', 
    ...
    model = VAE(args.input_dim, args.hidden_dims, args.latent_dim, args.output_dist).to(device)
